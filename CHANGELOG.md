...
* Stencil buffers can now be used, both with the main framebuffer and with `Canvas` rendering. ([@tesselode](https://github.com/sumibi-yakitori) in [#261](https://github.com/17cupsofcoffee/tetra/pull/261))
